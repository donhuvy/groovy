...
final class Groovy10281 {
    ...
    private static String logClassGen(boolean stacktrace) {
        def code = """
                println 'Hello, world!'
            """
        def result = new StringWriter()
        PrintWriter pw = new PrintWriter(result)
        def config = stacktrace ? new CompilerConfiguration(logClassgen: true, logClassgenStackTraceMaxDepth: 50, output: pw)
